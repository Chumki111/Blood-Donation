const ServiceCard = ({ service, reverse ,index}) => {
    return (
      <div className={`flex ${reverse ? 'flex-col md:flex-row-reverse text-right' : 'flex-col md:flex-row'} items-start gap-10`}>
        
        <img src={service.image} alt={service.title} className="w-full h-[90%] object-cover mb-4 rounded-lg" />
        <div className="flex flex-col ml-4 py-5">
            <h1 className="text-[#e7e7e7] text-7xl font-bold py-4">0{index+1}</h1>
